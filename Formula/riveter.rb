class Riveter < Formula
  ...
  if OS.mac? && Hardware::CPU.intel?
    url "https://github.com/ScottRyanHoward/riveter/releases/download/v0.23.0/riveter-0.23.0-macos-intel.tar.gz"
    sha256 "0fa73304b8fc15f5907563d6f364a5c1ea26b483b5274499b7043aad5403b69b"
  elsif OS.mac? && Hardware::CPU.arm?
    url "https://github.com/ScottRyanHoward/riveter/releases/download/v0.23.0/riveter-0.23.0-macos-arm64.tar.gz"
    sha256 "82c069c8b3326dab0f2768b81dc72564c631e69d3bff308655bc2b7b0fdbd242"
  elsif OS.linux?
    url "https://github.com/ScottRyanHoward/riveter/releases/download/v0.23.0/riveter-0.23.0-linux-x86_64.tar.gz"
    sha256 "ec66a3bafb02103fd4b4742b212758eb40e41a9fce943f31901e519a3d858d86"
  end

  resource "rule_packs" do
    url "https://github.com/ScottRyanHoward/riveter/archive/v0.23.0.tar.gz"
  ...
  test do
    ...
    assert_match "0.23.0", shell_output("#{bin}/riveter --version")
