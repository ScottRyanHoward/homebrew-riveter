class Riveter < Formula
  ...
  if OS.mac? && Hardware::CPU.intel?
    url "https://github.com/ScottRyanHoward/riveter/releases/download/v0.13.8/riveter-0.13.8-macos-intel.tar.gz"
    sha256 "PLACEHOLDER_CHECKSUM_MACOS_INTEL"
  elsif OS.mac? && Hardware::CPU.arm?
    url "https://github.com/ScottRyanHoward/riveter/releases/download/v0.13.8/riveter-0.13.8-macos-arm64.tar.gz"
    sha256 "PLACEHOLDER_CHECKSUM_MACOS_ARM64"
  elsif OS.linux?
    url "https://github.com/ScottRyanHoward/riveter/releases/download/v0.13.8/riveter-0.13.8-linux-x86_64.tar.gz"
    sha256 "PLACEHOLDER_CHECKSUM_LINUX_X86_64"
  end

  resource "rule_packs" do
    url "https://github.com/ScottRyanHoward/riveter/archive/v0.13.8.tar.gz"
  ...
  test do
    ...
    assert_match "0.13.8", shell_output("#{bin}/riveter --version")
